...
PRODUCT LIFE CYCLE:                 
                                    ...
                                    DEVELOPMENT: the first stage where we choose which product to build for the market doing some research and make it such that customer pain points are covered.
                                    GROWTH: marketing and promotional strategy, increasing online sales, other companies may try to tamp down our sales
                                    MATURITY: market reaches saturation, new competition comes up and sales slow down. we can try product bundling to increase sales.
...
IDEA GENERATION:     
       ...
       USER RESEARCH:                interviews, surveys, usability testing, and observation, among others.
                                     USER PERSONAS: fictional characters that represent a certain user perspective
                                     USER INTERVIEWS
...
AGILE METHODOLOGY:                   
                                      ...
                                      so agile: its an iterative approach to software dev. Instead of building a fully-featured product all at once, you break it down into small, functional pieces, ship them
